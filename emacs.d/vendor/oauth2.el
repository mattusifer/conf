...
(defadvice url-http-handle-authentication (around oauth-hack activate)
  (let ((url-http-extra-headers (if (boundp 'url-http-extra-headers)
                                    url-http-extra-headers nil))
        (url-callback-function (if (boundp 'url-callback-function)
                                    url-callback-function nil))
        (url-callback-arguments (if (boundp 'url-callback-arguments)
